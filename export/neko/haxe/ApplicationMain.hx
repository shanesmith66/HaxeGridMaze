...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("BlockGridMaze", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("BlockGridMaze", null, 600, 600);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "BlockGridMaze";
		app.meta["name"] = "BlockGridMaze";
